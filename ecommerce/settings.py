...
SECRET_KEY = 'django-insecure-*dht-=(8(&_p38fexxo^&e26^f39m!^=9sm@hb%&a8t0w(y$wd'
...
STATICFILES_DIRS =[
    ...
    os.path.join(BASE_DIR,'seller_app/static'),
    os.path.join(BASE_DIR,'customer_app/static'),
    os.path.join(BASE_DIR,'ecom_admin_app/static'),
